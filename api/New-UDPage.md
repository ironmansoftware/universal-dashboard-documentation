...
New-UDPage [-Name] <String> [[-Icon] <FontAwesomeIcons>] [[-Content] <ScriptBlock>]
 [-AuthorizedRole <String[]>] [-AuthorizationPolicy <String[]>] [-DefaultHomePage] [[-Title] <String>]
...
New-UDPage [[-Icon] <FontAwesomeIcons>] [[-Content] <ScriptBlock>] [-Url] <String> [-AuthorizedRole <String[]>]
 [-AuthorizationPolicy <String[]>] [-DefaultHomePage] [[-Title] <String>] [-Endpoint <ScriptBlock>]
...
### -AuthorizationPolicy
{{Fill AuthorizationPolicy Description}}
...
### -RefreshInterval
The refresh interval for the page.
